...
urlpatterns = [
    ...
    url(r'^graphs/performance_history/(?P<pk>[0-9]+)/$', views.PerformancesHistoricListView.as_view(), name='historic-list'),
    url(r'^graphs/performance_to bio_age/(?P<pk>[0-9]+)/$', views.PerformancesToBioAgeListView.as_view(),
